...
impl RemoveKeys {
    pub fn instruction(
        &self,
        args: RemoveKeysInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RemoveKeysInstructionData::new()).unwrap();
...
pub struct RemoveKeysInstructionData {
    discriminator: [u8; 8],
}

impl RemoveKeysInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for RemoveKeysInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RemoveKeysInstructionArgs {
    pub key_index: u16,
    pub keys_to_remove: [u16; 2],
}

/// Instruction builder for `RemoveKeys`.
///
/// ### Accounts:
///
///   0. `[writable]` funder
...
pub struct RemoveKeysBuilder {
    ...
    keys_to_remove: Option<[u16; 2]>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl RemoveKeysBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funder for the profile.
    ...
    #[inline(always)]
    pub fn keys_to_remove(&mut self, keys_to_remove: [u16; 2]) -> &mut Self {
        self.keys_to_remove = Some(keys_to_remove);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = RemoveKeysInstructionArgs {
            key_index: self.key_index.clone().expect("key_index is not set"),
            keys_to_remove: self
                .keys_to_remove
                .clone()
                .expect("keys_to_remove is not set"),
        };
...
/// `remove_keys` CPI accounts.
pub struct RemoveKeysCpiAccounts<'a, 'b> {
    /// The funder for the profile.
...
/// `remove_keys` CPI instruction.
pub struct RemoveKeysCpi<'a, 'b> {
    ...
    pub __args: RemoveKeysInstructionArgs,
}

impl<'a, 'b> RemoveKeysCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RemoveKeysCpiAccounts<'a, 'b>,
        args: RemoveKeysInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RemoveKeys` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` funder
...
///   3. `[]` system_program
#[derive(Clone, Debug)]
pub struct RemoveKeysCpiBuilder<'a, 'b> {
    instruction: Box<RemoveKeysCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveKeysCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveKeysCpiBuilderInstruction {
            __program: program,
            funder: None,
            key: None,
            profile: None,
    ...
    #[inline(always)]
    pub fn keys_to_remove(&mut self, keys_to_remove: [u16; 2]) -> &mut Self {
        self.instruction.keys_to_remove = Some(keys_to_remove);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
...
#[derive(Clone, Debug)]
struct RemoveKeysCpiBuilderInstruction<'a, 'b> {
