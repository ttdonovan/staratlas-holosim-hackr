...
impl AddExistingMemberToRole {
    pub fn instruction(
        &self,
        args: AddExistingMemberToRoleInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&AddExistingMemberToRoleInstructionData::new()).unwrap();
...
pub struct AddExistingMemberToRoleInstructionData {
    discriminator: [u8; 8],
}

impl AddExistingMemberToRoleInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for AddExistingMemberToRoleInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AddExistingMemberToRoleInstructionArgs {
    pub key_index: u16,
    pub key_index_in_membership_account: u16,
}

/// Instruction builder for `AddExistingMemberToRole`.
///
/// ### Accounts:
///
...
pub struct AddExistingMemberToRoleBuilder {
...
impl AddExistingMemberToRoleBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funder for reallocation.
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddExistingMemberToRole {
        ...
        let args = AddExistingMemberToRoleInstructionArgs {
...
/// `add_existing_member_to_role` CPI accounts.
pub struct AddExistingMemberToRoleCpiAccounts<'a, 'b> {
    /// The funder for reallocation.
...
/// `add_existing_member_to_role` CPI instruction.
pub struct AddExistingMemberToRoleCpi<'a, 'b> {
    ...
    pub __args: AddExistingMemberToRoleInstructionArgs,
}

impl<'a, 'b> AddExistingMemberToRoleCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddExistingMemberToRoleCpiAccounts<'a, 'b>,
        args: AddExistingMemberToRoleInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddExistingMemberToRole` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` funder
...
///   5. `[]` system_program
#[derive(Clone, Debug)]
pub struct AddExistingMemberToRoleCpiBuilder<'a, 'b> {
    instruction: Box<AddExistingMemberToRoleCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddExistingMemberToRoleCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddExistingMemberToRoleCpiBuilderInstruction {
            __program: program,
            funder: None,
            new_member: None,
            profile: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddExistingMemberToRoleCpi {
...
#[derive(Clone, Debug)]
struct AddExistingMemberToRoleCpiBuilderInstruction<'a, 'b> {
