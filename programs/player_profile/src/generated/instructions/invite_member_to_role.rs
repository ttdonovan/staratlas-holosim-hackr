...
impl InviteMemberToRole {
    pub fn instruction(
        &self,
        args: InviteMemberToRoleInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&InviteMemberToRoleInstructionData::new()).unwrap();
...
pub struct InviteMemberToRoleInstructionData {
    discriminator: [u8; 8],
}

impl InviteMemberToRoleInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for InviteMemberToRoleInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InviteMemberToRoleInstructionArgs {
    pub key_index: u16,
}

/// Instruction builder for `InviteMemberToRole`.
///
/// ### Accounts:
///
...
pub struct InviteMemberToRoleBuilder {
...
impl InviteMemberToRoleBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funder for the new profile.
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = InviteMemberToRole {
        ...
        let args = InviteMemberToRoleInstructionArgs {
...
/// `invite_member_to_role` CPI accounts.
pub struct InviteMemberToRoleCpiAccounts<'a, 'b> {
    /// The funder for the new profile.
...
/// `invite_member_to_role` CPI instruction.
pub struct InviteMemberToRoleCpi<'a, 'b> {
    ...
    pub __args: InviteMemberToRoleInstructionArgs,
}

impl<'a, 'b> InviteMemberToRoleCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InviteMemberToRoleCpiAccounts<'a, 'b>,
        args: InviteMemberToRoleInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InviteMemberToRole` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` funder
...
///   5. `[]` system_program
#[derive(Clone, Debug)]
pub struct InviteMemberToRoleCpiBuilder<'a, 'b> {
    instruction: Box<InviteMemberToRoleCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InviteMemberToRoleCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InviteMemberToRoleCpiBuilderInstruction {
            __program: program,
            funder: None,
            new_member: None,
            profile: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = InviteMemberToRoleCpi {
...
#[derive(Clone, Debug)]
struct InviteMemberToRoleCpiBuilderInstruction<'a, 'b> {
