...
impl LeaveRole {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&LeaveRoleInstructionData::new()).unwrap();
...
pub struct LeaveRoleInstructionData {
    discriminator: [u8; 8],
}

impl LeaveRoleInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for LeaveRoleInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl LeaveRoleBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = LeaveRoleInstructionArgs {
...
/// `leave_role` CPI accounts.
pub struct LeaveRoleCpiAccounts<'a, 'b> {
    /// The funder to receive the rent allocation.
...
/// `leave_role` CPI instruction.
pub struct LeaveRoleCpi<'a, 'b> {
    ...
    pub __args: LeaveRoleInstructionArgs,
}

impl<'a, 'b> LeaveRoleCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: LeaveRoleCpiAccounts<'a, 'b>,
        args: LeaveRoleInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `LeaveRole` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` funder
...
///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct LeaveRoleCpiBuilder<'a, 'b> {
    instruction: Box<LeaveRoleCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LeaveRoleCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(LeaveRoleCpiBuilderInstruction {
            __program: program,
            funder: None,
            member: None,
...
#[derive(Clone, Debug)]
struct LeaveRoleCpiBuilderInstruction<'a, 'b> {
