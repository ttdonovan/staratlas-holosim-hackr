...
impl SetRoleAcceptingMembers {
    pub fn instruction(
        &self,
        args: SetRoleAcceptingMembersInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SetRoleAcceptingMembersInstructionData::new()).unwrap();
...
pub struct SetRoleAcceptingMembersInstructionData {
    discriminator: [u8; 8],
}

impl SetRoleAcceptingMembersInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SetRoleAcceptingMembersInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SetRoleAcceptingMembersInstructionArgs {
    pub key_index: u16,
}

/// Instruction builder for `SetRoleAcceptingMembers`.
///
/// ### Accounts:
///
///   0. `[]` profile
...
pub struct SetRoleAcceptingMembersBuilder {
...
impl SetRoleAcceptingMembersBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The profile which owns the role being modified.
...
/// `set_role_accepting_members` CPI accounts.
pub struct SetRoleAcceptingMembersCpiAccounts<'a, 'b> {
    /// The profile which owns the role being modified.
...
/// `set_role_accepting_members` CPI instruction.
pub struct SetRoleAcceptingMembersCpi<'a, 'b> {
    ...
    pub __args: SetRoleAcceptingMembersInstructionArgs,
}

impl<'a, 'b> SetRoleAcceptingMembersCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SetRoleAcceptingMembersCpiAccounts<'a, 'b>,
        args: SetRoleAcceptingMembersInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetRoleAcceptingMembers` via CPI.
///
/// ### Accounts:
///
///   0. `[]` profile
///   1. `[writable]` role_account
#[derive(Clone, Debug)]
pub struct SetRoleAcceptingMembersCpiBuilder<'a, 'b> {
    instruction: Box<SetRoleAcceptingMembersCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetRoleAcceptingMembersCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetRoleAcceptingMembersCpiBuilderInstruction {
            __program: program,
            profile: None,
            role_account: None,
            key_index: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = SetRoleAcceptingMembersCpi {
...
#[derive(Clone, Debug)]
struct SetRoleAcceptingMembersCpiBuilderInstruction<'a, 'b> {
