...
pub fn fetch_all_fleet_ships(
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<FleetShips>> = Vec::new();
    for i in 0..addresses.len() {
        ...
        let data = FleetShips::from_bytes(&account.data)?;
...
pub fn fetch_all_maybe_fleet_ships(
    ...
    let accounts = rpc
        .get_multiple_accounts(addresses)
        .map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<FleetShips>> = Vec::new();
    for i in 0..addresses.len() {
        let address = addresses[i];
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for FleetShips {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for FleetShips {}

#[cfg(feature = "anchor")]
impl anchor_lang::Owner for FleetShips {
    fn owner() -> Pubkey {
        crate::SAGE_ID
    }
}
...
impl anchor_lang::IdlBuild for FleetShips {}
