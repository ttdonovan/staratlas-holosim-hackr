...
pub fn fetch_all_sage_player_profile(
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<SagePlayerProfile>> = Vec::new();
    for i in 0..addresses.len() {
        ...
        let data = SagePlayerProfile::from_bytes(&account.data)?;
...
pub fn fetch_all_maybe_sage_player_profile(
    ...
    let accounts = rpc
        .get_multiple_accounts(addresses)
        .map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<SagePlayerProfile>> = Vec::new();
    for i in 0..addresses.len() {
        let address = addresses[i];
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for SagePlayerProfile {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for SagePlayerProfile {}

#[cfg(feature = "anchor")]
impl anchor_lang::Owner for SagePlayerProfile {
    fn owner() -> Pubkey {
        crate::SAGE_ID
    }
}
...
impl anchor_lang::IdlBuild for SagePlayerProfile {}
