...
pub fn fetch_all_sage_crew_config(
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<SageCrewConfig>> = Vec::new();
    for i in 0..addresses.len() {
        ...
        let data = SageCrewConfig::from_bytes(&account.data)?;
...
pub fn fetch_all_maybe_sage_crew_config(
    ...
    let accounts = rpc
        .get_multiple_accounts(addresses)
        .map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<SageCrewConfig>> = Vec::new();
    for i in 0..addresses.len() {
        let address = addresses[i];
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for SageCrewConfig {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for SageCrewConfig {}

#[cfg(feature = "anchor")]
impl anchor_lang::Owner for SageCrewConfig {
    fn owner() -> Pubkey {
        crate::SAGE_ID
    }
}
...
impl anchor_lang::IdlBuild for SageCrewConfig {}
