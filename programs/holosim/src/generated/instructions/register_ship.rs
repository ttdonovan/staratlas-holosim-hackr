...
pub const REGISTER_SHIP_DISCRIMINATOR: [u8; 8] = [6, 51, 127, 92, 57, 76, 176, 165];
...
impl RegisterShip {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.ship, true));
        accounts.push(solana_instruction::AccountMeta::new_readonly(
            self.mint, false,
        ));
        accounts.push(solana_instruction::AccountMeta::new_readonly(
...
impl<'a, 'b> RegisterShipCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(*self.ship.key, true));
        accounts.push(solana_instruction::AccountMeta::new_readonly(
            *self.mint.key,
            false,
        ));
