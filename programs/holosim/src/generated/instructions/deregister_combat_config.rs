...
pub const DEREGISTER_COMBAT_CONFIG_DISCRIMINATOR: [u8; 8] =
    [201, 121, 177, 129, 147, 131, 145, 154];
...
impl DeregisterCombatConfig {
    pub fn instruction(
        &self,
        args: DeregisterCombatConfigInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&DeregisterCombatConfigInstructionData::new()).unwrap();
...
pub struct DeregisterCombatConfigInstructionData {
    discriminator: [u8; 8],
}

impl DeregisterCombatConfigInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [201, 121, 177, 129, 147, 131, 145, 154],
        }
    }
}

impl Default for DeregisterCombatConfigInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DeregisterCombatConfigInstructionArgs {
    pub input: KeyIndexInput,
}

/// Instruction builder for `DeregisterCombatConfig`.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
pub struct DeregisterCombatConfigBuilder {
...
impl DeregisterCombatConfigBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Where the closing funds go.
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = DeregisterCombatConfig {
        ...
        let args = DeregisterCombatConfigInstructionArgs {
...
/// `deregister_combat_config` CPI accounts.
pub struct DeregisterCombatConfigCpiAccounts<'a, 'b> {
    /// Where the closing funds go.
...
/// `deregister_combat_config` CPI instruction.
pub struct DeregisterCombatConfigCpi<'a, 'b> {
    ...
    pub __args: DeregisterCombatConfigInstructionArgs,
}

impl<'a, 'b> DeregisterCombatConfigCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: DeregisterCombatConfigCpiAccounts<'a, 'b>,
        args: DeregisterCombatConfigInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DeregisterCombatConfig` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
///   5. `[]` system_program
#[derive(Clone, Debug)]
pub struct DeregisterCombatConfigCpiBuilder<'a, 'b> {
    instruction: Box<DeregisterCombatConfigCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DeregisterCombatConfigCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DeregisterCombatConfigCpiBuilderInstruction {
            __program: program,
            funds_to: None,
            combat_config: None,
            key: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = DeregisterCombatConfigCpi {
...
#[derive(Clone, Debug)]
struct DeregisterCombatConfigCpiBuilderInstruction<'a, 'b> {
