...
pub const REGISTER_SECTOR_DISCRIMINATOR: [u8; 8] = [55, 57, 58, 192, 36, 235, 36, 109];
...
pub struct RegisterSectorBuilder {
    ...
    discoverer: Option<solana_pubkey::Pubkey>,
...
impl RegisterSectorBuilder {
    ...
    /// The discoverer of this sector
    #[inline(always)]
    pub fn discoverer(&mut self, discoverer: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct RegisterSectorCpiAccounts<'a, 'b> {
    ...
    /// The discoverer of this sector
    pub discoverer: &'b solana_account_info::AccountInfo<'a>,
    /// The [`Sector`] account
...
impl<'a, 'b> RegisterSectorCpiBuilder<'a, 'b> {
    ...
    pub fn discoverer(
        &mut self,
        discoverer: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct RegisterSectorCpiBuilderInstruction<'a, 'b> {
    ...
    discoverer: Option<&'b solana_account_info::AccountInfo<'a>>,
