...
pub const UPDATE_STAR_DISCRIMINATOR: [u8; 8] = [145, 146, 12, 86, 12, 48, 39, 169];
...
impl UpdateStar {
    pub fn instruction(&self, args: UpdateStarInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.star, false));
...
impl<'a, 'b> UpdateStarCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(*self.star.key, false));
