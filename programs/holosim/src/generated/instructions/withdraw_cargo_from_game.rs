...
pub const WITHDRAW_CARGO_FROM_GAME_DISCRIMINATOR: [u8; 8] = [102, 218, 88, 53, 255, 194, 24, 62];
...
impl WithdrawCargoFromGame {
    pub fn instruction(
        &self,
        args: WithdrawCargoFromGameInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&WithdrawCargoFromGameInstructionData::new()).unwrap();
...
pub struct WithdrawCargoFromGameInstructionData {
    discriminator: [u8; 8],
}

impl WithdrawCargoFromGameInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [102, 218, 88, 53, 255, 194, 24, 62],
        }
    }
}

impl Default for WithdrawCargoFromGameInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct WithdrawCargoFromGameInstructionArgs {
    pub input: CargoToGameInput,
}

/// Instruction builder for `WithdrawCargoFromGame`.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
pub struct WithdrawCargoFromGameBuilder {
...
impl WithdrawCargoFromGameBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funds_to - receives rent refund
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = WithdrawCargoFromGame {
        ...
        let args = WithdrawCargoFromGameInstructionArgs {
...
/// `withdraw_cargo_from_game` CPI accounts.
pub struct WithdrawCargoFromGameCpiAccounts<'a, 'b> {
    /// The funds_to - receives rent refund
...
/// `withdraw_cargo_from_game` CPI instruction.
pub struct WithdrawCargoFromGameCpi<'a, 'b> {
    ...
    pub __args: WithdrawCargoFromGameInstructionArgs,
}

impl<'a, 'b> WithdrawCargoFromGameCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: WithdrawCargoFromGameCpiAccounts<'a, 'b>,
        args: WithdrawCargoFromGameInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WithdrawCargoFromGame` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
///   15. `[]` token_program
#[derive(Clone, Debug)]
pub struct WithdrawCargoFromGameCpiBuilder<'a, 'b> {
    instruction: Box<WithdrawCargoFromGameCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawCargoFromGameCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WithdrawCargoFromGameCpiBuilderInstruction {
            __program: program,
            funds_to: None,
            starbase: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = WithdrawCargoFromGameCpi {
...
#[derive(Clone, Debug)]
struct WithdrawCargoFromGameCpiBuilderInstruction<'a, 'b> {
