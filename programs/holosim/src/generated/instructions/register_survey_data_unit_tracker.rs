...
pub struct RegisterSurveyDataUnitTracker {
    ...
    pub sdu_mint: solana_program::pubkey::Pubkey,
    /// The mint of the resource spent when scanning for SDUs
    pub resource_mint: solana_program::pubkey::Pubkey,
...
pub struct RegisterSurveyDataUnitTrackerBuilder {
    ...
    sdu_mint: Option<solana_program::pubkey::Pubkey>,
    resource_mint: Option<solana_program::pubkey::Pubkey>,
...
impl RegisterSurveyDataUnitTrackerBuilder {
    ...
    /// The Survey Data Unit Mint
    #[inline(always)]
    pub fn sdu_mint(&mut self, sdu_mint: solana_program::pubkey::Pubkey) -> &mut Self {
        self.sdu_mint = Some(sdu_mint);
        self
    }
    /// The mint of the resource spent when scanning for SDUs
    #[inline(always)]
    pub fn resource_mint(&mut self, resource_mint: solana_program::pubkey::Pubkey) -> &mut Self {
...
pub struct RegisterSurveyDataUnitTrackerCpiAccounts<'a, 'b> {
    ...
    /// The Survey Data Unit Mint
    pub sdu_mint: &'b solana_program::account_info::AccountInfo<'a>,
    /// The mint of the resource spent when scanning for SDUs
    pub resource_mint: &'b solana_program::account_info::AccountInfo<'a>,
    /// The Solana System program
...
impl<'a, 'b> RegisterSurveyDataUnitTrackerCpiBuilder<'a, 'b> {
    ...
    pub fn sdu_mint(
        &mut self,
        sdu_mint: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn resource_mint(
        &mut self,
        resource_mint: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct RegisterSurveyDataUnitTrackerCpiBuilderInstruction<'a, 'b> {
    ...
    sdu_mint: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    resource_mint: Option<&'b solana_program::account_info::AccountInfo<'a>>,
