...
pub const REGISTER_STAR_DISCRIMINATOR: [u8; 8] = [15, 25, 105, 234, 177, 215, 147, 191];
...
impl RegisterStar {
    pub fn instruction(
        &self,
        args: RegisterStarInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.star, true));
        ...
        let mut data = borsh::to_vec(&RegisterStarInstructionData::new()).unwrap();
...
pub struct RegisterStarInstructionData {
    discriminator: [u8; 8],
}

impl RegisterStarInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [15, 25, 105, 234, 177, 215, 147, 191],
        }
    }
}

impl Default for RegisterStarInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RegisterStarInstructionArgs {
    pub name: [u8; 64],
    pub size: u64,
...
/// Instruction builder for `RegisterStar`.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   4. `[writable, signer]` star
///   5. `[writable]` sector
///   6. `[optional]` system_program (default to `11111111111111111111111111111111`)
#[derive(Clone, Debug, Default)]
pub struct RegisterStarBuilder {
    ...
    star: Option<solana_pubkey::Pubkey>,
...
impl RegisterStarBuilder {
    ...
    /// The [`Star`] account
    #[inline(always)]
    pub fn star(&mut self, star: solana_pubkey::Pubkey) -> &mut Self {
        self.star = Some(star);
        self
    }
    /// The [`Sector`] account
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = RegisterStarInstructionArgs {
            ...
            star_type: self.star_type.clone().expect("star_type is not set"),
...
/// `register_star` CPI accounts.
pub struct RegisterStarCpiAccounts<'a, 'b> {
    /// The key authorized for this instruction
    ...
    /// The [`Star`] account
    pub star: &'b solana_account_info::AccountInfo<'a>,
    /// The [`Sector`] account
...
/// `register_star` CPI instruction.
pub struct RegisterStarCpi<'a, 'b> {
    ...
    pub __args: RegisterStarInstructionArgs,
}

impl<'a, 'b> RegisterStarCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: RegisterStarCpiAccounts<'a, 'b>,
        args: RegisterStarInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(*self.star.key, true));
...
/// Instruction builder for `RegisterStar` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   6. `[]` system_program
#[derive(Clone, Debug)]
pub struct RegisterStarCpiBuilder<'a, 'b> {
    instruction: Box<RegisterStarCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RegisterStarCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RegisterStarCpiBuilderInstruction {
            __program: program,
            key: None,
            profile: None,
            game_id: None,
    ...
    /// The [`Star`] account
    #[inline(always)]
    pub fn star(&mut self, star: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = RegisterStarCpi {
...
#[derive(Clone, Debug)]
struct RegisterStarCpiBuilderInstruction<'a, 'b> {
    ...
    star: Option<&'b solana_account_info::AccountInfo<'a>>,
