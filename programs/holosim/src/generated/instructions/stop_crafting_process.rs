...
pub const STOP_CRAFTING_PROCESS_DISCRIMINATOR: [u8; 8] = [49, 192, 172, 244, 79, 44, 170, 178];
...
impl StopCraftingProcess {
    pub fn instruction(
        &self,
        args: StopCraftingProcessInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&StopCraftingProcessInstructionData::new()).unwrap();
...
pub struct StopCraftingProcessInstructionData {
    discriminator: [u8; 8],
}

impl StopCraftingProcessInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [49, 192, 172, 244, 79, 44, 170, 178],
        }
    }
}

impl Default for StopCraftingProcessInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct StopCraftingProcessInstructionArgs {
    pub input: KeyIndexInput,
}

/// Instruction builder for `StopCraftingProcess`.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
pub struct StopCraftingProcessBuilder {
...
impl StopCraftingProcessBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The [`Starbase`] account
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = StopCraftingProcess {
        ...
        let args = StopCraftingProcessInstructionArgs {
...
/// `stop_crafting_process` CPI accounts.
pub struct StopCraftingProcessCpiAccounts<'a, 'b> {
    /// The [`Starbase`] account
...
/// `stop_crafting_process` CPI instruction.
pub struct StopCraftingProcessCpi<'a, 'b> {
    ...
    pub __args: StopCraftingProcessInstructionArgs,
}

impl<'a, 'b> StopCraftingProcessCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: StopCraftingProcessCpiAccounts<'a, 'b>,
        args: StopCraftingProcessInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `StopCraftingProcess` via CPI.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
///   11. `[]` crafting_program
#[derive(Clone, Debug)]
pub struct StopCraftingProcessCpiBuilder<'a, 'b> {
    instruction: Box<StopCraftingProcessCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> StopCraftingProcessCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(StopCraftingProcessCpiBuilderInstruction {
            __program: program,
            starbase: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = StopCraftingProcessCpi {
...
#[derive(Clone, Debug)]
struct StopCraftingProcessCpiBuilderInstruction<'a, 'b> {
