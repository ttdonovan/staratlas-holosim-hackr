...
pub const REMOVE_INVALID_SHIP_ESCROW_DISCRIMINATOR: [u8; 8] = [248, 15, 16, 197, 13, 248, 39, 0];
...
impl RemoveInvalidShipEscrow {
    pub fn instruction(
        &self,
        args: RemoveInvalidShipEscrowInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RemoveInvalidShipEscrowInstructionData::new()).unwrap();
...
pub struct RemoveInvalidShipEscrowInstructionData {
    discriminator: [u8; 8],
}

impl RemoveInvalidShipEscrowInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [248, 15, 16, 197, 13, 248, 39, 0],
        }
    }
}

impl Default for RemoveInvalidShipEscrowInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RemoveInvalidShipEscrowInstructionArgs {
    pub input: RemoveShipEscrowInput,
}

/// Instruction builder for `RemoveInvalidShipEscrow`.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
pub struct RemoveInvalidShipEscrowBuilder {
...
impl RemoveInvalidShipEscrowBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The key authorized for this instruction
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = RemoveInvalidShipEscrow {
        ...
        let args = RemoveInvalidShipEscrowInstructionArgs {
...
/// `remove_invalid_ship_escrow` CPI accounts.
pub struct RemoveInvalidShipEscrowCpiAccounts<'a, 'b> {
    /// The key authorized for this instruction
...
/// `remove_invalid_ship_escrow` CPI instruction.
pub struct RemoveInvalidShipEscrowCpi<'a, 'b> {
    ...
    pub __args: RemoveInvalidShipEscrowInstructionArgs,
}

impl<'a, 'b> RemoveInvalidShipEscrowCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: RemoveInvalidShipEscrowCpiAccounts<'a, 'b>,
        args: RemoveInvalidShipEscrowInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RemoveInvalidShipEscrow` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   13. `[]` system_program
#[derive(Clone, Debug)]
pub struct RemoveInvalidShipEscrowCpiBuilder<'a, 'b> {
    instruction: Box<RemoveInvalidShipEscrowCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveInvalidShipEscrowCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveInvalidShipEscrowCpiBuilderInstruction {
            __program: program,
            key: None,
            profile: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = RemoveInvalidShipEscrowCpi {
...
#[derive(Clone, Debug)]
struct RemoveInvalidShipEscrowCpiBuilderInstruction<'a, 'b> {
