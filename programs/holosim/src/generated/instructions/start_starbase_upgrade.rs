...
pub const START_STARBASE_UPGRADE_DISCRIMINATOR: [u8; 8] = [165, 225, 83, 167, 158, 211, 143, 205];
...
impl StartStarbaseUpgrade {
    pub fn instruction(
        &self,
        args: StartStarbaseUpgradeInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&StartStarbaseUpgradeInstructionData::new()).unwrap();
...
pub struct StartStarbaseUpgradeInstructionData {
    discriminator: [u8; 8],
}

impl StartStarbaseUpgradeInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [165, 225, 83, 167, 158, 211, 143, 205],
        }
    }
}

impl Default for StartStarbaseUpgradeInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct StartStarbaseUpgradeInstructionArgs {
    pub input: KeyIndexInput,
}

/// Instruction builder for `StartStarbaseUpgrade`.
///
/// ### Accounts:
///
...
pub struct StartStarbaseUpgradeBuilder {
...
impl StartStarbaseUpgradeBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funder for the new crafting process
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = StartStarbaseUpgrade {
        ...
        let args = StartStarbaseUpgradeInstructionArgs {
...
/// `start_starbase_upgrade` CPI accounts.
pub struct StartStarbaseUpgradeCpiAccounts<'a, 'b> {
    /// The funder for the new crafting process
...
/// `start_starbase_upgrade` CPI instruction.
pub struct StartStarbaseUpgradeCpi<'a, 'b> {
    ...
    pub __args: StartStarbaseUpgradeInstructionArgs,
}

impl<'a, 'b> StartStarbaseUpgradeCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: StartStarbaseUpgradeCpiAccounts<'a, 'b>,
        args: StartStarbaseUpgradeInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `StartStarbaseUpgrade` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` funder
...
///   10. `[]` system_program
#[derive(Clone, Debug)]
pub struct StartStarbaseUpgradeCpiBuilder<'a, 'b> {
    instruction: Box<StartStarbaseUpgradeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> StartStarbaseUpgradeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(StartStarbaseUpgradeCpiBuilderInstruction {
            __program: program,
            funder: None,
            starbase: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = StartStarbaseUpgradeCpi {
...
#[derive(Clone, Debug)]
struct StartStarbaseUpgradeCpiBuilderInstruction<'a, 'b> {
