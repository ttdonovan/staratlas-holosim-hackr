...
impl WithdrawCraftingIngredient {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&WithdrawCraftingIngredientInstructionData::new()).unwrap();
...
pub struct WithdrawCraftingIngredientInstructionData {
    discriminator: [u8; 8],
}

impl WithdrawCraftingIngredientInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [218, 0, 207, 77, 253, 116, 248, 250],
        }
    }
}

impl Default for WithdrawCraftingIngredientInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct WithdrawCraftingIngredientInstructionArgs {
    pub amount: u64,
    pub ingredient_index: u16,
    pub key_index: u16,
}

/// Instruction builder for `WithdrawCraftingIngredient`.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
/// Instruction builder for `WithdrawCraftingIngredient` via CPI.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
///   19. `[]` token_program
#[derive(Clone, Debug)]
pub struct WithdrawCraftingIngredientCpiBuilder<'a, 'b> {
    instruction: Box<WithdrawCraftingIngredientCpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> WithdrawCraftingIngredientCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = WithdrawCraftingIngredientCpi {
