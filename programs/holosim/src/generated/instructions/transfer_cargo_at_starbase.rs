...
pub const TRANSFER_CARGO_AT_STARBASE_DISCRIMINATOR: [u8; 8] =
    [12, 190, 166, 190, 123, 119, 214, 80];
...
impl TransferCargoAtStarbase {
    pub fn instruction(
        &self,
        args: TransferCargoAtStarbaseInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&TransferCargoAtStarbaseInstructionData::new()).unwrap();
...
pub struct TransferCargoAtStarbaseInstructionData {
    discriminator: [u8; 8],
}

impl TransferCargoAtStarbaseInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [12, 190, 166, 190, 123, 119, 214, 80],
        }
    }
}

impl Default for TransferCargoAtStarbaseInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct TransferCargoAtStarbaseInstructionArgs {
    pub amount: u64,
    pub key_index: u16,
}

/// Instruction builder for `TransferCargoAtStarbase`.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
///   4. `[writable]` cargo_pod_to
///   5. `[]` cargo_type
///   6. `[]` cargo_stats_definition
///   7. `[signer]` key
///   8. `[]` profile
///   9. `[]` profile_faction
///   10. `[]` game_id
...
pub struct TransferCargoAtStarbaseBuilder {
...
impl TransferCargoAtStarbaseBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funds_to - receives rent refund
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = TransferCargoAtStarbase {
        ...
        let args = TransferCargoAtStarbaseInstructionArgs {
...
/// `transfer_cargo_at_starbase` CPI accounts.
pub struct TransferCargoAtStarbaseCpiAccounts<'a, 'b> {
    /// The funds_to - receives rent refund
...
/// `transfer_cargo_at_starbase` CPI instruction.
pub struct TransferCargoAtStarbaseCpi<'a, 'b> {
    ...
    pub __args: TransferCargoAtStarbaseInstructionArgs,
}

impl<'a, 'b> TransferCargoAtStarbaseCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: TransferCargoAtStarbaseCpiAccounts<'a, 'b>,
        args: TransferCargoAtStarbaseInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `TransferCargoAtStarbase` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
///   16. `[]` token_program
#[derive(Clone, Debug)]
pub struct TransferCargoAtStarbaseCpiBuilder<'a, 'b> {
    instruction: Box<TransferCargoAtStarbaseCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> TransferCargoAtStarbaseCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(TransferCargoAtStarbaseCpiBuilderInstruction {
            __program: program,
            funds_to: None,
            starbase: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = TransferCargoAtStarbaseCpi {
...
#[derive(Clone, Debug)]
struct TransferCargoAtStarbaseCpiBuilderInstruction<'a, 'b> {
