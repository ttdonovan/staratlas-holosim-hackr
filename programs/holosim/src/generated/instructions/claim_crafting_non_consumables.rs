...
pub const CLAIM_CRAFTING_NON_CONSUMABLES_DISCRIMINATOR: [u8; 8] =
    [18, 145, 170, 128, 59, 241, 83, 136];
...
impl ClaimCraftingNonConsumables {
    pub fn instruction(
        &self,
        args: ClaimCraftingNonConsumablesInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ClaimCraftingNonConsumablesInstructionData::new()).unwrap();
...
pub struct ClaimCraftingNonConsumablesInstructionData {
    discriminator: [u8; 8],
}

impl ClaimCraftingNonConsumablesInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [18, 145, 170, 128, 59, 241, 83, 136],
        }
    }
}

impl Default for ClaimCraftingNonConsumablesInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimCraftingNonConsumablesInstructionArgs {
    pub input: IngredientIndexInput,
}

/// Instruction builder for `ClaimCraftingNonConsumables`.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
impl ClaimCraftingNonConsumablesBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The [`Starbase`] account
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = ClaimCraftingNonConsumables {
        ...
        let args = ClaimCraftingNonConsumablesInstructionArgs {
...
/// `claim_crafting_non_consumables` CPI accounts.
pub struct ClaimCraftingNonConsumablesCpiAccounts<'a, 'b> {
    /// The [`Starbase`] account
...
/// `claim_crafting_non_consumables` CPI instruction.
pub struct ClaimCraftingNonConsumablesCpi<'a, 'b> {
    ...
    pub __args: ClaimCraftingNonConsumablesInstructionArgs,
}

impl<'a, 'b> ClaimCraftingNonConsumablesCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ClaimCraftingNonConsumablesCpiAccounts<'a, 'b>,
        args: ClaimCraftingNonConsumablesInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ClaimCraftingNonConsumables` via CPI.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
///   16. `[]` token_program
#[derive(Clone, Debug)]
pub struct ClaimCraftingNonConsumablesCpiBuilder<'a, 'b> {
    instruction: Box<ClaimCraftingNonConsumablesCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimCraftingNonConsumablesCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClaimCraftingNonConsumablesCpiBuilderInstruction {
            __program: program,
            starbase: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = ClaimCraftingNonConsumablesCpi {
...
#[derive(Clone, Debug)]
struct ClaimCraftingNonConsumablesCpiBuilderInstruction<'a, 'b> {
