...
pub const REDEEM_CERTIFICATE_DISCRIMINATOR: [u8; 8] = [212, 241, 133, 172, 137, 83, 49, 177];
...
pub struct RedeemCertificateBuilder {
    ...
    certificate_token_from: Option<solana_pubkey::Pubkey>,
...
impl RedeemCertificateBuilder {
    ...
    pub fn certificate_token_from(
        &mut self,
        certificate_token_from: solana_pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct RedeemCertificateCpiAccounts<'a, 'b> {
    ...
    /// The source token account for the cargo certificate - owned by the starbase player or a
    /// `certificate_owner_authority` sent through remaining accounts
    pub certificate_token_from: &'b solana_account_info::AccountInfo<'a>,
    /// The source token account for the cargo - owned by the Starbase
...
impl<'a, 'b> RedeemCertificateCpiBuilder<'a, 'b> {
    ...
    pub fn certificate_token_from(
        &mut self,
        certificate_token_from: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct RedeemCertificateCpiBuilderInstruction<'a, 'b> {
    ...
    certificate_token_from: Option<&'b solana_account_info::AccountInfo<'a>>,
