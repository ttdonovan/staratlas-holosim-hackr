...
pub struct RedeemCertificate {
    ...
    /// The source token account for the cargo certificate - owned by the starbase player or a
    /// `certificate_owner_authority` sent through remaining accounts
    pub certificate_token_from: solana_program::pubkey::Pubkey,
...
impl RedeemCertificate {
    pub fn instruction(
        &self,
        args: RedeemCertificateInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RedeemCertificateInstructionData::new()).unwrap();
...
pub struct RedeemCertificateInstructionData {
    discriminator: [u8; 8],
}

impl RedeemCertificateInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [212, 241, 133, 172, 137, 83, 49, 177],
        }
    }
}

impl Default for RedeemCertificateInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RedeemCertificateInstructionArgs {
    pub key_index: u16,
    pub amount: u64,
}

/// Instruction builder for `RedeemCertificate`.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
///   7. `[writable]` funds_to
///   8. `[]` cargo_mint
///   9. `[writable]` certificate_mint
///   10. `[writable]` certificate_token_from
///   11. `[writable]` cargo_token_from
///   12. `[writable]` cargo_token_to
///   13. `[writable]` cargo_pod
///   14. `[]` cargo_type
///   15. `[]` cargo_stats_definition
///   16. `[]` cargo_program
///   17. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   18. `[]` token2022_program
#[derive(Clone, Debug, Default)]
pub struct RedeemCertificateBuilder {
    ...
    certificate_token_from: Option<solana_program::pubkey::Pubkey>,
...
impl RedeemCertificateBuilder {
    ...
    /// `certificate_owner_authority` sent through remaining accounts
    #[inline(always)]
    pub fn certificate_token_from(
        &mut self,
        certificate_token_from: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.certificate_token_from = Some(certificate_token_from);
        self
    }
    /// The source token account for the cargo - owned by the Starbase
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RedeemCertificate {
            ...
            certificate_token_from: self
                .certificate_token_from
                .expect("certificate_token_from is not set"),
        ...
        let args = RedeemCertificateInstructionArgs {
...
/// `redeem_certificate` CPI accounts.
pub struct RedeemCertificateCpiAccounts<'a, 'b> {
    /// The [`Starbase`] account
    ...
    /// The source token account for the cargo certificate - owned by the starbase player or a
    /// `certificate_owner_authority` sent through remaining accounts
    pub certificate_token_from: &'b solana_program::account_info::AccountInfo<'a>,
    /// The source token account for the cargo - owned by the Starbase
...
/// `redeem_certificate` CPI instruction.
pub struct RedeemCertificateCpi<'a, 'b> {
    ...
    pub __args: RedeemCertificateInstructionArgs,
}

impl<'a, 'b> RedeemCertificateCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RedeemCertificateCpiAccounts<'a, 'b>,
        args: RedeemCertificateInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
            ...
            certificate_token_from: accounts.certificate_token_from,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.certificate_token_from.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
        ...
        account_infos.push(self.certificate_token_from.clone());
...
/// Instruction builder for `RedeemCertificate` via CPI.
///
/// ### Accounts:
///
///   0. `[]` starbase
...
///   18. `[]` token2022_program
#[derive(Clone, Debug)]
pub struct RedeemCertificateCpiBuilder<'a, 'b> {
    instruction: Box<RedeemCertificateCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RedeemCertificateCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RedeemCertificateCpiBuilderInstruction {
            __program: program,
            starbase: None,
    ...
    pub fn certificate_token_from(
        &mut self,
        certificate_token_from: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.certificate_token_from = Some(certificate_token_from);
        self
    }
    /// The source token account for the cargo - owned by the Starbase
    #[inline(always)]
    ...
    pub fn invoke_signed(
        ...
        let instruction = RedeemCertificateCpi {
...
#[derive(Clone, Debug)]
struct RedeemCertificateCpiBuilderInstruction<'a, 'b> {
    ...
    certificate_token_from: Option<&'b solana_program::account_info::AccountInfo<'a>>,
