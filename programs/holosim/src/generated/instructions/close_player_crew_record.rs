...
pub struct ClosePlayerCrewRecord {
    ...
    pub crew_record: solana_program::pubkey::Pubkey,
...
pub struct ClosePlayerCrewRecordBuilder {
    ...
    crew_record: Option<solana_program::pubkey::Pubkey>,
...
impl ClosePlayerCrewRecordBuilder {
    ...
    /// The [`PlayerCrewRecord`] account
    #[inline(always)]
    pub fn crew_record(&mut self, crew_record: solana_program::pubkey::Pubkey) -> &mut Self {
...
pub struct ClosePlayerCrewRecordCpiAccounts<'a, 'b> {
    ...
    /// The [`PlayerCrewRecord`] account
    pub crew_record: &'b solana_program::account_info::AccountInfo<'a>,
    /// The key authorized for this instruction
...
impl<'a, 'b> ClosePlayerCrewRecordCpiBuilder<'a, 'b> {
    ...
    pub fn crew_record(
        &mut self,
        crew_record: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct ClosePlayerCrewRecordCpiBuilderInstruction<'a, 'b> {
    ...
    crew_record: Option<&'b solana_program::account_info::AccountInfo<'a>>,
