...
pub const REGISTER_STARBASE_DISCRIMINATOR: [u8; 8] = [105, 33, 36, 138, 165, 181, 51, 57];
...
impl RegisterStarbase {
    pub fn instruction(
        &self,
        args: RegisterStarbaseInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RegisterStarbaseInstructionData::new()).unwrap();
...
pub struct RegisterStarbaseInstructionData {
    discriminator: [u8; 8],
}

impl RegisterStarbaseInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [105, 33, 36, 138, 165, 181, 51, 57],
        }
    }
}

impl Default for RegisterStarbaseInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RegisterStarbaseInstructionArgs {
    pub name: [u8; 64],
...
/// Instruction builder for `RegisterStarbase`.
///
/// ### Accounts:
///
...
pub struct RegisterStarbaseBuilder {
    ...
    starbase_level_index: Option<u8>,
    faction: Option<u8>,
    key_index: Option<u16>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl RegisterStarbaseBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funder for the new star base
    ...
    #[inline(always)]
    pub fn starbase_level_index(&mut self, starbase_level_index: u8) -> &mut Self {
        self.starbase_level_index = Some(starbase_level_index);
        self
    }
    #[inline(always)]
    pub fn faction(&mut self, faction: u8) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = RegisterStarbaseInstructionArgs {
            name: self.name.clone().expect("name is not set"),
            sub_coordinates: self
                .sub_coordinates
                .clone()
                .expect("sub_coordinates is not set"),
            starbase_level_index: self
                .starbase_level_index
                .clone()
                .expect("starbase_level_index is not set"),
            faction: self.faction.clone().expect("faction is not set"),
...
/// `register_starbase` CPI accounts.
pub struct RegisterStarbaseCpiAccounts<'a, 'b> {
    /// The funder for the new star base
...
/// `register_starbase` CPI instruction.
pub struct RegisterStarbaseCpi<'a, 'b> {
    ...
    pub __args: RegisterStarbaseInstructionArgs,
}

impl<'a, 'b> RegisterStarbaseCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: RegisterStarbaseCpiAccounts<'a, 'b>,
        args: RegisterStarbaseInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RegisterStarbase` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` funder
...
///   7. `[]` system_program
#[derive(Clone, Debug)]
pub struct RegisterStarbaseCpiBuilder<'a, 'b> {
    instruction: Box<RegisterStarbaseCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RegisterStarbaseCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RegisterStarbaseCpiBuilderInstruction {
            __program: program,
            funder: None,
            starbase: None,
            sector: None,
    ...
    #[inline(always)]
    pub fn starbase_level_index(&mut self, starbase_level_index: u8) -> &mut Self {
        self.instruction.starbase_level_index = Some(starbase_level_index);
        self
    }
    #[inline(always)]
    pub fn faction(&mut self, faction: u8) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = RegisterStarbaseCpi {
...
#[derive(Clone, Debug)]
struct RegisterStarbaseCpiBuilderInstruction<'a, 'b> {
