...
pub const UPDATE_GAME_DISCRIMINATOR: [u8; 8] = [159, 61, 132, 131, 3, 234, 209, 220];
...
impl UpdateGame {
    pub fn instruction(&self, args: UpdateGameInstructionArgs) -> solana_instruction::Instruction {
