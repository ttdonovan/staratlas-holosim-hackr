...
pub const LOAD_FLEET_CREW_DISCRIMINATOR: [u8; 8] = [39, 9, 212, 218, 167, 107, 137, 208];
...
impl LoadFleetCrew {
    pub fn instruction(
        &self,
        args: LoadFleetCrewInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&LoadFleetCrewInstructionData::new()).unwrap();
...
pub struct LoadFleetCrewInstructionData {
    discriminator: [u8; 8],
}

impl LoadFleetCrewInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [39, 9, 212, 218, 167, 107, 137, 208],
        }
    }
}

impl Default for LoadFleetCrewInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct LoadFleetCrewInstructionArgs {
    pub input: FleetCrewInput,
}

/// Instruction builder for `LoadFleetCrew`.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
pub struct LoadFleetCrewBuilder {
...
impl LoadFleetCrewBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = LoadFleetCrewInstructionArgs {
...
/// `load_fleet_crew` CPI accounts.
pub struct LoadFleetCrewCpiAccounts<'a, 'b> {
    /// The key on the profile.
...
/// `load_fleet_crew` CPI instruction.
pub struct LoadFleetCrewCpi<'a, 'b> {
    ...
    pub __args: LoadFleetCrewInstructionArgs,
}

impl<'a, 'b> LoadFleetCrewCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: LoadFleetCrewCpiAccounts<'a, 'b>,
        args: LoadFleetCrewInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `LoadFleetCrew` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   6. `[]` game_id
#[derive(Clone, Debug)]
pub struct LoadFleetCrewCpiBuilder<'a, 'b> {
    instruction: Box<LoadFleetCrewCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LoadFleetCrewCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(LoadFleetCrewCpiBuilderInstruction {
            __program: program,
            key: None,
            owning_profile: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = LoadFleetCrewCpi {
...
#[derive(Clone, Debug)]
struct LoadFleetCrewCpiBuilderInstruction<'a, 'b> {
