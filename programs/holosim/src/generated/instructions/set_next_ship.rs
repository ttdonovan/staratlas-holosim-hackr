...
pub const SET_NEXT_SHIP_DISCRIMINATOR: [u8; 8] = [184, 239, 118, 237, 92, 169, 177, 174];
...
impl SetNextShip {
    pub fn instruction(&self, args: SetNextShipInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.next_ship, false));
...
pub struct SetNextShipBuilder {
    ...
    next_ship: Option<solana_pubkey::Pubkey>,
...
impl SetNextShipBuilder {
    ...
    /// The next [`Ship`] account
    #[inline(always)]
    pub fn next_ship(&mut self, next_ship: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct SetNextShipCpiAccounts<'a, 'b> {
    ...
    /// The next [`Ship`] account
    pub next_ship: &'b solana_account_info::AccountInfo<'a>,
}
...
impl<'a, 'b> SetNextShipCpiBuilder<'a, 'b> {
    ...
    /// The next [`Ship`] account
    #[inline(always)]
    pub fn next_ship(&mut self, next_ship: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
struct SetNextShipCpiBuilderInstruction<'a, 'b> {
    ...
    next_ship: Option<&'b solana_account_info::AccountInfo<'a>>,
    key_index: Option<u16>,
