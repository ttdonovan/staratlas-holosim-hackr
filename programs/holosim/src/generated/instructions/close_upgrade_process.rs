...
impl CloseUpgradeProcess {
    pub fn instruction(
        &self,
        args: CloseUpgradeProcessInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CloseUpgradeProcessInstructionData::new()).unwrap();
...
pub struct CloseUpgradeProcessInstructionData {
    discriminator: [u8; 8],
}

impl CloseUpgradeProcessInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [214, 132, 138, 123, 136, 17, 89, 82],
        }
    }
}

impl Default for CloseUpgradeProcessInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CloseUpgradeProcessInstructionArgs {
    pub input: KeyIndexInput,
}

/// Instruction builder for `CloseUpgradeProcess`.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
///   3. `[writable]` resource_crafting_instance
///   4. `[writable]` resource_crafting_process
///   5. `[]` resource_recipe
///   6. `[writable]` resource_crafting_facility
///   7. `[signer]` key
///   8. `[]` profile
///   9. `[]` profile_faction
///   10. `[]` game_id
...
pub struct CloseUpgradeProcessBuilder {
...
impl CloseUpgradeProcessBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The funds_to - receives rent refund
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CloseUpgradeProcess {
        ...
        let args = CloseUpgradeProcessInstructionArgs {
...
/// `close_upgrade_process` CPI accounts.
pub struct CloseUpgradeProcessCpiAccounts<'a, 'b> {
    /// The funds_to - receives rent refund
...
/// `close_upgrade_process` CPI instruction.
pub struct CloseUpgradeProcessCpi<'a, 'b> {
    ...
    pub __args: CloseUpgradeProcessInstructionArgs,
}

impl<'a, 'b> CloseUpgradeProcessCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CloseUpgradeProcessCpiAccounts<'a, 'b>,
        args: CloseUpgradeProcessInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CloseUpgradeProcess` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` funds_to
...
///   12. `[]` crafting_program
#[derive(Clone, Debug)]
pub struct CloseUpgradeProcessCpiBuilder<'a, 'b> {
    instruction: Box<CloseUpgradeProcessCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CloseUpgradeProcessCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CloseUpgradeProcessCpiBuilderInstruction {
            __program: program,
            funds_to: None,
            starbase: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CloseUpgradeProcessCpi {
...
#[derive(Clone, Debug)]
struct CloseUpgradeProcessCpiBuilderInstruction<'a, 'b> {
