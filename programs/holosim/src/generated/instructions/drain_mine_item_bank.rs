...
impl DrainMineItemBank {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&DrainMineItemBankInstructionData::new()).unwrap();
...
pub struct DrainMineItemBankInstructionData {
    discriminator: [u8; 8],
}

impl DrainMineItemBankInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [221, 76, 92, 127, 230, 35, 41, 67],
        }
    }
}

impl Default for DrainMineItemBankInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DrainMineItemBankInstructionArgs {
    pub input: KeyIndexInput,
}

/// Instruction builder for `DrainMineItemBank`.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
/// Instruction builder for `DrainMineItemBank` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   7. `[]` token_program
#[derive(Clone, Debug)]
pub struct DrainMineItemBankCpiBuilder<'a, 'b> {
    instruction: Box<DrainMineItemBankCpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> DrainMineItemBankCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = DrainMineItemBankCpi {
