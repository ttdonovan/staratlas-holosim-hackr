...
impl RegisterProgressionConfig {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RegisterProgressionConfigInstructionData::new()).unwrap();
...
pub struct RegisterProgressionConfigInstructionData {
    discriminator: [u8; 8],
}

impl RegisterProgressionConfigInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [21, 65, 0, 240, 76, 135, 85, 219],
        }
    }
}

impl Default for RegisterProgressionConfigInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RegisterProgressionConfigInstructionArgs {
...
/// Instruction builder for `RegisterProgressionConfig`.
///
/// ### Accounts:
///
...
/// Instruction builder for `RegisterProgressionConfig` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` funder
...
///   5. `[]` system_program
#[derive(Clone, Debug)]
pub struct RegisterProgressionConfigCpiBuilder<'a, 'b> {
    instruction: Box<RegisterProgressionConfigCpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> RegisterProgressionConfigCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = RegisterProgressionConfigCpi {
