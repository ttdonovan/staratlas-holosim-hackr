...
pub const IDLE_TO_LOADING_BAY_DISCRIMINATOR: [u8; 8] = [227, 46, 4, 74, 151, 248, 41, 131];
...
impl IdleToLoadingBay {
    pub fn instruction(
        &self,
        args: IdleToLoadingBayInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&IdleToLoadingBayInstructionData::new()).unwrap();
...
pub struct IdleToLoadingBayInstructionData {
    discriminator: [u8; 8],
}

impl IdleToLoadingBayInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [227, 46, 4, 74, 151, 248, 41, 131],
        }
    }
}

impl Default for IdleToLoadingBayInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct IdleToLoadingBayInstructionArgs {
    pub key_index: u16,
}

/// Instruction builder for `IdleToLoadingBay`.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
pub struct IdleToLoadingBayBuilder {
...
impl IdleToLoadingBayBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = IdleToLoadingBayInstructionArgs {
...
/// `idle_to_loading_bay` CPI accounts.
pub struct IdleToLoadingBayCpiAccounts<'a, 'b> {
    /// The key on the profile.
...
/// `idle_to_loading_bay` CPI instruction.
pub struct IdleToLoadingBayCpi<'a, 'b> {
    ...
    pub __args: IdleToLoadingBayInstructionArgs,
}

impl<'a, 'b> IdleToLoadingBayCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: IdleToLoadingBayCpiAccounts<'a, 'b>,
        args: IdleToLoadingBayInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `IdleToLoadingBay` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   7. `[writable]` starbase_player
#[derive(Clone, Debug)]
pub struct IdleToLoadingBayCpiBuilder<'a, 'b> {
    instruction: Box<IdleToLoadingBayCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> IdleToLoadingBayCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(IdleToLoadingBayCpiBuilderInstruction {
            __program: program,
            key: None,
            owning_profile: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = IdleToLoadingBayCpi {
...
#[derive(Clone, Debug)]
struct IdleToLoadingBayCpiBuilderInstruction<'a, 'b> {
