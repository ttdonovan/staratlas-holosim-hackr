...
impl IdleToRespawn {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&IdleToRespawnInstructionData::new()).unwrap();
...
pub struct IdleToRespawnInstructionData {
    discriminator: [u8; 8],
}

impl IdleToRespawnInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [235, 207, 200, 174, 161, 116, 91, 168],
        }
    }
}

impl Default for IdleToRespawnInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct IdleToRespawnInstructionArgs {
    pub key_index: u16,
}

/// Instruction builder for `IdleToRespawn`.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   4. `[]` game_id
///   5. `[]` game_state
///   6. `[writable]` atlas_token_from
///   7. `[writable]` atlas_token_to
...
/// Instruction builder for `IdleToRespawn` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` key
...
///   8. `[]` token_program
#[derive(Clone, Debug)]
pub struct IdleToRespawnCpiBuilder<'a, 'b> {
    instruction: Box<IdleToRespawnCpiBuilderInstruction<'a, 'b>>,
}
...
impl<'a, 'b> IdleToRespawnCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = IdleToRespawnCpi {
